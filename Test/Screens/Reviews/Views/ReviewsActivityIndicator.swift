//
//  ReviewsActivityIndicator.swift
//  Test
//
//  Created by Fedorova Maria on 02.03.2025.
//

import UIKit

final class ReviewsActivityIndicator: UIView {
    ...
    private lazy var shapeLayer: CAShapeLayer = {
        ...
        shapeLayer.fillColor = .activityIndicator
        return shapeLayer
    }()
    ...
    convenience init(squareLength: CGFloat) {
        ...
        let rect = CGRect(
            origin: CGPoint(
                x: (mainBounds.width - squareLength) / 2,
    ...
    func stopAnimation() {
        guard shapeLayer.animation(forKey: keyAnimation) != nil else { return }
